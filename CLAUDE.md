...
- Go 1.25 + gopkg.in/yaml.v3 (YAML parsing), github.com/google/uuid (Session ID generation) (001-config-driven-workflow)
- File-based YAML storage (report.yaml, history.yaml) in session-specific directories (001-config-driven-workflow)
