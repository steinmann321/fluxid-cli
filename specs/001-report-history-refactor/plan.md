...
**Scale/Scope**:
- Single CLI binary with embedded YAML schema documents
...
- 2 YAML schema documents embedded at internal/assets/templates/ (report-schema.yaml, history-schema.yaml)
