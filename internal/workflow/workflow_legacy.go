...
// runLegacyWorkflow executes the old hardcoded 3-step workflow (implement, commit, review).
// This is kept for backward compatibility if workflow section is not configured.
func runLegacyWorkflow(cfg types.Config) (int, error) {
